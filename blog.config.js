...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Zhu Shatong', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我是一个同济大学数据科学本科生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zhushatong.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 朱沙桐, zhushatong, shatong', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '656597803@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Zhu-Shatong', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  // 自定义外部脚本，外部样式
  CUSTOM_EXTERNAL_JS: ['http://fm.goodq.top/cache/ZmFzdG15bmEtMjkyNS02NDk0MTk2ZmNmMzg4.js'], // e.g. ['http://xx.com/script.js','http://xx.com/script.js']
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://zst-twikoo.zeabur.app/', // TWIKOO地址 腾讯云环境填 envId；Vercel 环境域名地址（https://xxx.vercel.app)
